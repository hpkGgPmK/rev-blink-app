.class public final Lcom/ring/android/safe/recycler/decoration/delegate/DividerDescriptionAreaDecorationDelegate;
.super Ljava/lang/Object;
.source "DividerDescriptionAreaDecorationDelegate.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/ring/android/safe/recycler/decoration/delegate/DividerDescriptionAreaDecorationDelegate;",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/ring/android/safe/recycler/decoration/delegate/DividerDescriptionAreaDecorationDelegate;->drawable:Landroid/graphics/drawable/Drawable;
...
.method public isForCurrentCase(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$State;)Z
    ...
    instance-of p1, p1, Lcom/ring/android/safe/area/DescriptionArea;
...
.method public onDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$State;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    iget-object p3, p0, Lcom/ring/android/safe/recycler/decoration/delegate/DividerDescriptionAreaDecorationDelegate;->drawable:Landroid/graphics/drawable/Drawable;
    ...
    instance-of v0, p3, Lcom/ring/android/safe/header/SectionHeader;

    if-nez v0, :cond_0

    instance-of p3, p3, Lcom/ring/android/safe/cell/HintCell;
    ...
    iget-object v0, p0, Lcom/ring/android/safe/recycler/decoration/delegate/DividerDescriptionAreaDecorationDelegate;->drawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, p3, v2, v3}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    :cond_1
    invoke-static {p2, p4}, Lcom/ring/android/safe/recycler/ExtensionsKt;->getPreviousChildView(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-virtual {p3, p4, v0, p5, p2}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object p2, p0, Lcom/ring/android/safe/recycler/decoration/delegate/DividerDescriptionAreaDecorationDelegate;->drawable:Landroid/graphics/drawable/Drawable;
