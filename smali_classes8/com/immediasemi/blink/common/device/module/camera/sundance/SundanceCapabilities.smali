.class public final Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;
.super Ljava/lang/Object;
.source "SundanceCapabilities.kt"
...
.method public constructor <init>(Lcom/immediasemi/blink/db/accessories/AccessoryRepository;)V
    ...
    iput-object p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->accessoryRepository:Lcom/immediasemi/blink/db/accessories/AccessoryRepository;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->supportsModularOnboarding:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->ledControl:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->temperatureCalibration:Z

    const/4 v0, 0x2

    new-array v0, v0, [Lcom/immediasemi/blink/db/accessories/AccessoryType;
    ...
    sget-object v1, Lcom/immediasemi/blink/db/accessories/AccessoryType;->BATTERY_EXTENSION_PACK_ACCESSORY:Lcom/immediasemi/blink/db/accessories/AccessoryType;
    ...
    iput-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->supportedAccessories:Ljava/util/List;

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->batteryDriven:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->allowsWEP:Z
...
.method public getAllowsWEP()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->allowsWEP:Z
...
.method public getBatteryDriven()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->batteryDriven:Z
...
.method public getLedControl()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->ledControl:Z
...
.method public getSupportedAccessories()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->supportedAccessories:Ljava/util/List;
...
.method public getSupportsModularOnboarding()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->supportsModularOnboarding:Z
...
.method public getTemperatureCalibration()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->temperatureCalibration:Z
...
.method public light(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p3, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;

    if-eqz v0, :cond_0

    move-object v0, p3

    check-cast v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;

    iget v1, v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;->label:I
    ...
    iget p3, v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;->label:I

    sub-int/2addr p3, v2

    iput p3, v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;

    invoke-direct {v0, p0, p3}, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;-><init>(Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p3, v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;->result:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/IntrinsicsKt;->getCOROUTINE_SUSPENDED()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;->label:I
    ...
    iget-object p3, p0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities;->accessoryRepository:Lcom/immediasemi/blink/db/accessories/AccessoryRepository;

    sget-object v2, Lcom/immediasemi/blink/db/accessories/AccessoryType;->LIGHT_ACCESSORY:Lcom/immediasemi/blink/db/accessories/AccessoryType;

    iput v3, v0, Lcom/immediasemi/blink/common/device/module/camera/sundance/SundanceCapabilities$light$1;->label:I
