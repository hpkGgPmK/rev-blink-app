.class public final Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;
.super Ljava/lang/Object;
.source "LotusCapabilities.kt"
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nLotusCapabilities.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LotusCapabilities.kt\ncom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,36:1\n1#2:37\n*E\n"
.end annotation
...
.method public constructor <init>(Lcom/immediasemi/blink/db/CameraRepository;)V
    ...
    iput-object p1, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->cameraRepository:Lcom/immediasemi/blink/db/CameraRepository;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->alertVolumeControl:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->chime:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->buttonLedControl:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->earlyNotificationControl:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->allowsWEP:Z
...
.method public connection(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p3, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;

    if-eqz v0, :cond_0

    move-object v0, p3

    check-cast v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;

    iget v1, v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;->label:I
    ...
    iget p3, v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;->label:I

    sub-int/2addr p3, v2

    iput p3, v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;

    invoke-direct {v0, p0, p3}, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;-><init>(Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p3, v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;->result:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/IntrinsicsKt;->getCOROUTINE_SUSPENDED()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;->label:I
    ...
    iget-object p3, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->cameraRepository:Lcom/immediasemi/blink/db/CameraRepository;

    iput v3, v0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities$connection$1;->label:I
    ...
    invoke-virtual {p0, p3}, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->connection(Lcom/immediasemi/blink/db/Camera;)Lcom/immediasemi/blink/common/device/Connection;
...
.method public getAlertVolumeControl()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->alertVolumeControl:Z
...
.method public getAllowsWEP()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->allowsWEP:Z
...
.method public getButtonLedControl()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->buttonLedControl:Z
...
.method public getChime()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->chime:Z
...
.method public getEarlyNotificationControl()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->earlyNotificationControl:Z
...
.method public getLedControl()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->ledControl:Z
...
.method public getRequiresSyncModule()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->requiresSyncModule:Z
...
.method public getTemperatureCalibration()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/lotus/LotusCapabilities;->temperatureCalibration:Z
