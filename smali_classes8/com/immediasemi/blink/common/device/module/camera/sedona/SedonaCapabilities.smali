.class public final Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;
.super Ljava/lang/Object;
.source "SedonaCapabilities.kt"
...
.method public constructor <init>(Lcom/immediasemi/blink/db/accessories/AccessoryRepository;)V
    ...
    iput-object p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->accessoryRepository:Lcom/immediasemi/blink/db/accessories/AccessoryRepository;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->ledControl:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->temperatureCalibration:Z

    iput-boolean p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->allowsWEP:Z
    ...
    iput-object p1, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->supportedAccessories:Ljava/util/List;
...
.method public getAllowsWEP()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->allowsWEP:Z
...
.method public getLedControl()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->ledControl:Z
...
.method public getSupportedAccessories()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->supportedAccessories:Ljava/util/List;
...
.method public getTemperatureCalibration()Z
    ...
    iget-boolean v0, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->temperatureCalibration:Z
...
.method public light(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p3, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;

    if-eqz v0, :cond_0

    move-object v0, p3

    check-cast v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;

    iget v1, v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;->label:I
    ...
    iget p3, v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;->label:I

    sub-int/2addr p3, v2

    iput p3, v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;

    invoke-direct {v0, p0, p3}, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;-><init>(Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p3, v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;->result:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/IntrinsicsKt;->getCOROUTINE_SUSPENDED()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;->label:I
    ...
    iget-object p3, p0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities;->accessoryRepository:Lcom/immediasemi/blink/db/accessories/AccessoryRepository;

    sget-object v2, Lcom/immediasemi/blink/db/accessories/AccessoryType;->LIGHT_ACCESSORY:Lcom/immediasemi/blink/db/accessories/AccessoryType;

    iput v3, v0, Lcom/immediasemi/blink/common/device/module/camera/sedona/SedonaCapabilities$light$1;->label:I
