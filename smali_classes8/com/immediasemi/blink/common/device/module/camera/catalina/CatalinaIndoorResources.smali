.class public final Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;
.super Ljava/lang/Object;
.source "CatalinaIndoorResources.kt"
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources$WhenMappings;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->genericName:I

    sget v0, Lcom/immediasemi/blink/R$string;->cameras:I

    iput v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->genericNamePlural:I

    sget v0, Lcom/immediasemi/blink/R$string;->indoor_3:I

    iput v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->productName:I

    sget v0, Lcom/immediasemi/blink/R$drawable;->catalina_indoor:I

    iput v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->defaultProductImage:I

    invoke-static {}, Lkotlin/collections/MapsKt;->emptyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->stringMap:Ljava/util/Map;

    invoke-static {}, Lkotlin/collections/MapsKt;->emptyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->imageMap:Ljava/util/Map;

    sget-object v0, Lcom/immediasemi/blink/common/url/UrlKey;->INDOOR_OUTDOOR:Lcom/immediasemi/blink/common/url/UrlKey;

    iput-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->helpUrl:Lcom/immediasemi/blink/common/url/UrlKey;

    invoke-static {}, Lkotlin/collections/MapsKt;->emptyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->onboardingMap:Ljava/util/Map;
...
.method public getDefaultProductImage()I
    ...
    iget v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->defaultProductImage:I
...
.method public getGenericName()I
    ...
    iget v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->genericName:I
...
.method public getGenericNamePlural()I
    ...
    iget v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->genericNamePlural:I
...
.method public getHelpUrl()Lcom/immediasemi/blink/common/url/UrlKey;
    ...
    iget-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->helpUrl:Lcom/immediasemi/blink/common/url/UrlKey;
...
.method public getImageMap()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->imageMap:Ljava/util/Map;
...
.method public getOnboardingMap()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->onboardingMap:Ljava/util/Map;
...
.method public getProductName()I
    ...
    iget v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->productName:I
...
.method public getStringMap()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources;->stringMap:Ljava/util/Map;
...
.method public productImage(Lcom/immediasemi/blink/common/device/camera/CameraColor;)Ljava/lang/Integer;
    ...
    sget-object v0, Lcom/immediasemi/blink/common/device/module/camera/catalina/CatalinaIndoorResources$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    sget p1, Lcom/immediasemi/blink/R$drawable;->catalina_indoor:I
