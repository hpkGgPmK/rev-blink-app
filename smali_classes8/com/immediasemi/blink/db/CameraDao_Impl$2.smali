.class public final Lcom/immediasemi/blink/db/CameraDao_Impl$2;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nCameraDao_Impl.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CameraDao_Impl.kt\ncom/immediasemi/blink/db/CameraDao_Impl$2\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2322:1\n1#2:2323\n*E\n"
.end annotation
...
.method constructor <init>(Lcom/immediasemi/blink/db/CameraDao_Impl;)V
    ...
    iput-object p1, p0, Lcom/immediasemi/blink/db/CameraDao_Impl$2;->this$0:Lcom/immediasemi/blink/db/CameraDao_Impl;
...
.method protected bind(Landroidx/sqlite/SQLiteStatement;Lcom/immediasemi/blink/db/Camera;)V
    ...
    :goto_5
    iget-object v0, p0, Lcom/immediasemi/blink/db/CameraDao_Impl$2;->this$0:Lcom/immediasemi/blink/db/CameraDao_Impl;
...
.method public bridge synthetic bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/immediasemi/blink/db/CameraDao_Impl$2;->bind(Landroidx/sqlite/SQLiteStatement;Lcom/immediasemi/blink/db/Camera;)V
...
.method protected createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `camera` SET `id` = ?,`network_id` = ?,`created_at` = ?,`updated_at` = ?,`armed` = ?,`name` = ?,`type` = ?,`thumbnail` = ?,`status` = ?,`battery` = ?,`usage_rate` = ?,`priority` = ?,`issues` = ?,`wifi_signal` = ?,`lfr_signal` = ?,`onboarded` = ?,`serial_number` = ?,`local_storage_compatible` = ?,`local_storage_enabled` = ?,`subscription_id` = ?,`lotus_doorbell_mode` = ?,`lotus_config_out_of_sync` = ?,`revision` = ?,`snooze_time_remaining` = ?,`color` = ?,`network_type` = ?,`vo9_compatible` = ?,`thumbnail_timestamp` = ? WHERE `id` = ?"
