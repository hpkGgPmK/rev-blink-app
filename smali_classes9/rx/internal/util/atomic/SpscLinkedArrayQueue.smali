...
.method public offer(Ljava/lang/Object;)Z
    ...
    iget v6, p0, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->producerMask:I

    invoke-static {v3, v4, v6}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->calcWrappedOffset(JI)I

    move-result v5

    iget-wide v7, p0, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->producerLookAhead:J
    ...
    iget p1, v0, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->producerLookAheadStep:I

    int-to-long v7, p1

    add-long/2addr v7, v3

    invoke-static {v7, v8, v6}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->calcWrappedOffset(JI)I

    move-result p1

    invoke-static {v1, p1}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->lvElement(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    iput-wide v7, v0, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->producerLookAhead:J
