...
.method public static schedulePeriodically(Lrx/Scheduler$Worker;Lrx/functions/Action0;JJLjava/util/concurrent/TimeUnit;Lrx/internal/schedulers/SchedulePeriodicHelper$NowNanoSupplier;)Lrx/Subscription;
    ...
    new-instance v9, Lrx/internal/subscriptions/SequentialSubscription;

    invoke-direct {v9, v14}, Lrx/internal/subscriptions/SequentialSubscription;-><init>(Lrx/Subscription;)V

    new-instance v3, Lrx/internal/schedulers/SchedulePeriodicHelper$1;
    ...
    invoke-virtual {p0, v3, v0, v1, v2}, Lrx/Scheduler$Worker;->schedule(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/Subscription;

    move-result-object p0

    invoke-virtual {v14, p0}, Lrx/internal/subscriptions/SequentialSubscription;->replace(Lrx/Subscription;)Z
