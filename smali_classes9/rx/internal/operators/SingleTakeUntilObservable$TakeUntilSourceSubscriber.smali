...
.method constructor <init>(Lrx/SingleSubscriber;)V
    ...
    iput-object p1, p0, Lrx/internal/operators/SingleTakeUntilObservable$TakeUntilSourceSubscriber;->once:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Lrx/internal/operators/SingleTakeUntilObservable$TakeUntilSourceSubscriber$OtherSubscriber;

    invoke-direct {p1, p0}, Lrx/internal/operators/SingleTakeUntilObservable$TakeUntilSourceSubscriber$OtherSubscriber;-><init>(Lrx/internal/operators/SingleTakeUntilObservable$TakeUntilSourceSubscriber;)V

    iput-object p1, p0, Lrx/internal/operators/SingleTakeUntilObservable$TakeUntilSourceSubscriber;->other:Lrx/Subscriber;

    invoke-virtual {p0, p1}, Lrx/internal/operators/SingleTakeUntilObservable$TakeUntilSourceSubscriber;->add(Lrx/Subscription;)V
