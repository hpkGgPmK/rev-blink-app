...
.method public call(Lrx/Subscriber;)V
    ...
    new-instance v11, Lrx/subscriptions/SerialSubscription;

    invoke-direct {v11}, Lrx/subscriptions/SerialSubscription;-><init>()V
    ...
    invoke-virtual {v1}, Lrx/subjects/BehaviorSubject;->toSerialized()Lrx/subjects/SerializedSubject;
    ...
    invoke-virtual {v8, v1}, Lrx/subjects/Subject;->subscribe(Lrx/Subscriber;)Lrx/Subscription;

    new-instance v3, Lrx/internal/producers/ProducerArbiter;

    invoke-direct {v3}, Lrx/internal/producers/ProducerArbiter;-><init>()V

    new-instance v6, Lrx/internal/operators/OnSubscribeRedo$2;
    ...
    invoke-direct/range {v5 .. v11}, Lrx/internal/operators/OnSubscribeRedo$2;-><init>(Lrx/internal/operators/OnSubscribeRedo;Lrx/Subscriber;Lrx/subjects/Subject;Lrx/internal/producers/ProducerArbiter;Ljava/util/concurrent/atomic/AtomicLong;Lrx/subscriptions/SerialSubscription;)V
    ...
    iget-object p1, v1, Lrx/internal/operators/OnSubscribeRedo;->controlHandlerFunction:Lrx/functions/Func1;

    new-instance v5, Lrx/internal/operators/OnSubscribeRedo$3;

    invoke-direct {v5, p0}, Lrx/internal/operators/OnSubscribeRedo$3;-><init>(Lrx/internal/operators/OnSubscribeRedo;)V

    invoke-virtual {v8, v5}, Lrx/subjects/Subject;->lift(Lrx/Observable$Operator;)Lrx/Observable;
    ...
    new-instance v0, Lrx/internal/operators/OnSubscribeRedo$4;
    ...
    invoke-virtual {v5, v0}, Lrx/Scheduler$Worker;->schedule(Lrx/functions/Action0;)Lrx/Subscription;

    new-instance v0, Lrx/internal/operators/OnSubscribeRedo$5;
    ...
    invoke-virtual {v7, v0}, Lrx/Subscriber;->setProducer(Lrx/Producer;)V
