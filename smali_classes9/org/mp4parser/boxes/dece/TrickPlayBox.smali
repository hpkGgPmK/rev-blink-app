.class public Lorg/mp4parser/boxes/dece/TrickPlayBox;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/mp4parser/boxes/dece/TrickPlayBox$Entry;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$preClinit()V
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->entries:Ljava/util/List;
...
.method private static synthetic ajc$preClinit()V
    ...
    const-class v2, Lorg/mp4parser/boxes/dece/TrickPlayBox;
    ...
    const-string v3, "org.mp4parser.boxes.dece.TrickPlayBox"
    ...
    sput-object v1, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$tjp_0:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
    ...
    sput-object v1, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$tjp_1:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
    ...
    sput-object v0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$tjp_2:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
...
.method public _parseDetails(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1}, Lorg/mp4parser/boxes/dece/TrickPlayBox;->parseVersionAndFlags(Ljava/nio/ByteBuffer;)J
    ...
    :cond_0
    iget-object v0, p0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->entries:Ljava/util/List;

    new-instance v1, Lorg/mp4parser/boxes/dece/TrickPlayBox$Entry;

    invoke-static {p1}, Lorg/mp4parser/tools/IsoTypeReader;->readUInt8(Ljava/nio/ByteBuffer;)I

    move-result v2

    invoke-direct {v1, v2}, Lorg/mp4parser/boxes/dece/TrickPlayBox$Entry;-><init>(I)V
...
.method protected getContent(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1}, Lorg/mp4parser/boxes/dece/TrickPlayBox;->writeVersionAndFlags(Ljava/nio/ByteBuffer;)V
    ...
    check-cast v1, Lorg/mp4parser/boxes/dece/TrickPlayBox$Entry;

    invoke-static {v1}, Lorg/mp4parser/boxes/dece/TrickPlayBox$Entry;->access$0(Lorg/mp4parser/boxes/dece/TrickPlayBox$Entry;)I
...
.method public getEntries()Ljava/util/List;
    ...
    sget-object v0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$tjp_0:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
...
.method public setEntries(Ljava/util/List;)V
    ...
    sget-object v0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$tjp_1:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
    ...
    iput-object p1, p0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->entries:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    sget-object v0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->ajc$tjp_2:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
    ...
    iget-object v1, p0, Lorg/mp4parser/boxes/dece/TrickPlayBox;->entries:Ljava/util/List;
