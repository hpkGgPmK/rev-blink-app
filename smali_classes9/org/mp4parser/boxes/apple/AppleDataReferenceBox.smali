.class public Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$preClinit()V
...
.method private static synthetic ajc$preClinit()V
    ...
    const-class v2, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;
    ...
    const-string v3, "org.mp4parser.boxes.apple.AppleDataReferenceBox"
    ...
    sput-object v1, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$tjp_0:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
    ...
    sput-object v1, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$tjp_1:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
    ...
    sput-object v0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$tjp_2:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
...
.method public _parseDetails(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1}, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->parseVersionAndFlags(Ljava/nio/ByteBuffer;)J

    invoke-static {p1}, Lorg/mp4parser/tools/IsoTypeReader;->read4cc(Ljava/nio/ByteBuffer;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->dataReferenceType:Ljava/lang/String;
    ...
    iput v0, p0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->dataReferenceSize:I

    invoke-static {p1, v0}, Lorg/mp4parser/tools/IsoTypeReader;->readString(Ljava/nio/ByteBuffer;I)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->dataReference:Ljava/lang/String;
...
.method protected getContent(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1}, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->writeVersionAndFlags(Ljava/nio/ByteBuffer;)V

    iget-object v0, p0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->dataReferenceType:Ljava/lang/String;
    ...
    iget v0, p0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->dataReferenceSize:I

    int-to-long v0, v0

    invoke-static {p1, v0, v1}, Lorg/mp4parser/tools/IsoTypeWriter;->writeUInt32(Ljava/nio/ByteBuffer;J)V

    iget-object v0, p0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->dataReference:Ljava/lang/String;
...
.method public getDataReference()Ljava/lang/String;
    ...
    sget-object v0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$tjp_2:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
...
.method public getDataReferenceSize()J
    ...
    sget-object v0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$tjp_0:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
...
.method public getDataReferenceType()Ljava/lang/String;
    ...
    sget-object v0, Lorg/mp4parser/boxes/apple/AppleDataReferenceBox;->ajc$tjp_1:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
