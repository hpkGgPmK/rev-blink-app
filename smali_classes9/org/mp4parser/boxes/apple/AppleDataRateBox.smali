.class public Lorg/mp4parser/boxes/apple/AppleDataRateBox;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->ajc$preClinit()V
...
.method private static synthetic ajc$preClinit()V
    ...
    const-class v2, Lorg/mp4parser/boxes/apple/AppleDataRateBox;
    ...
    const-string v3, "org.mp4parser.boxes.apple.AppleDataRateBox"
    ...
    sput-object v0, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->ajc$tjp_0:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
...
.method public _parseDetails(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1}, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->parseVersionAndFlags(Ljava/nio/ByteBuffer;)J

    invoke-static {p1}, Lorg/mp4parser/tools/IsoTypeReader;->readUInt32(Ljava/nio/ByteBuffer;)J

    move-result-wide v0

    iput-wide v0, p0, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->dataRate:J
...
.method protected getContent(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1}, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->writeVersionAndFlags(Ljava/nio/ByteBuffer;)V

    iget-wide v0, p0, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->dataRate:J
...
.method public getDataRate()J
    ...
    sget-object v0, Lorg/mp4parser/boxes/apple/AppleDataRateBox;->ajc$tjp_0:Lorg/mp4parser/aj/lang/JoinPoint$StaticPart;
