...
.method public static synthetic $r8$lambda$9lCAYZqSaY_qlF3ymp1sxdib9UE(Landroidx/window/embedding/SplitPlaceholderRule;Landroid/content/Context;Landroid/view/WindowMetrics;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$Pf9ptpGQZmJJybj13uDjrKIybrk(Landroidx/window/embedding/ActivityRule;Landroid/content/Intent;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$TYrxSHh8wjSkAiOyJr-57-SAYa0(Landroidx/window/embedding/SplitPlaceholderRule;Landroid/app/Activity;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$iQb3h2Lt_bdnSrjSuo1Q48Y3KM8(Landroidx/window/embedding/ActivityRule;Landroid/app/Activity;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$zHEm1V4iQiLJFgwrkdXdE9AGuzs(Landroidx/window/embedding/SplitPlaceholderRule;Landroid/content/Intent;)Z
    .locals 0
...
.method private final translate(Landroidx/window/extensions/embedding/SplitInfo;)Landroidx/window/embedding/SplitInfo;
    ...
    const-string/jumbo v4, "splitInfo.token"
...
.method private final translateActivityRule(Landroidx/window/embedding/ActivityRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/ActivityRule;
    ...
    :cond_0
    new-instance p2, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda7;

    invoke-direct {p2, p1}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda7;-><init>(Landroidx/window/embedding/ActivityRule;)V
...
.method private final translateSplitPairRule(Landroid/content/Context;Landroidx/window/embedding/SplitPairRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPairRule;
    ...
    :cond_0
    new-instance p3, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda4;

    invoke-direct {p3, p2}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda4;-><init>(Landroidx/window/embedding/SplitPairRule;)V
    ...
    invoke-direct {v1, p2, p1}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda6;-><init>(Landroidx/window/embedding/SplitPairRule;Landroid/content/Context;)V
...
.method private final translateSplitPlaceholderRule(Landroid/content/Context;Landroidx/window/embedding/SplitPlaceholderRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPlaceholderRule;
    ...
    invoke-direct {p3, p2}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda0;-><init>(Landroidx/window/embedding/SplitPlaceholderRule;)V
    ...
    invoke-direct {v1, p2, p1}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda2;-><init>(Landroidx/window/embedding/SplitPlaceholderRule;Landroid/content/Context;)V
...
.method public final translate$window_release(Landroidx/window/extensions/embedding/SplitAttributes;)Landroidx/window/embedding/SplitAttributes;
    ...
    const-string/jumbo v2, "splitAttributes.splitType"
