.class public final Lcom/amazon/identity/auth/device/n0;
...
.method public constructor <init>(Lcom/amazon/identity/auth/device/token/OAuthTokenManager;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/amazon/identity/auth/device/n0;->b:Lcom/amazon/identity/auth/device/token/v;
...
.method public static a(Lcom/amazon/identity/auth/device/t2;Lcom/amazon/identity/auth/device/q7$a;)V
    ...
    const-string p1, "ActorUpdatePinHelper"
    ...
    sget-object v2, Lcom/amazon/identity/auth/device/n0$a;->a:[I
...
.method protected final a(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    const-string v1, "ActorUpdatePinHelper"
    ...
    const-string v0, "Cannot get loading url from json response for update pin flow"
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/amazon/identity/auth/device/t2;Landroid/os/Bundle;Lorg/json/JSONObject;Lcom/amazon/identity/auth/device/ob;)V
    ...
    const-string v11, "ActorUpdatePinHelper"

    const-class v0, Lcom/amazon/identity/auth/device/activity/ActorUpdatePinActivity;
    ...
    :try_start_0
    invoke-virtual {p0, v2}, Lcom/amazon/identity/auth/device/n0;->a(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    new-instance v9, Lcom/amazon/identity/auth/device/m0;

    invoke-direct {v9, v1}, Lcom/amazon/identity/auth/device/m0;-><init>(Lcom/amazon/identity/auth/device/t2;)V

    iget-object v2, p0, Lcom/amazon/identity/auth/device/n0;->b:Lcom/amazon/identity/auth/device/token/v;
    ...
    :catch_0
    const-string p1, "Cannot parse JSON response for update pin request"
    ...
    const-string p2, "Cannot get cookies before launching the update pin UI"
    ...
    const-string p2, "No activity can handle the intent. Probably because you do not declare ActorUpdatePinActivity in Android manifest"
