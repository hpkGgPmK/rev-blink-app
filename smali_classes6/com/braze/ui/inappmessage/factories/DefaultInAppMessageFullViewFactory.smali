...
# direct methods
.method public static synthetic $r8$lambda$jLZjIS-TEcJDErHfjnoa2Tfm8wI(Landroid/view/View;Lcom/braze/ui/inappmessage/views/InAppMessageFullView;Lcom/braze/models/inappmessage/InAppMessageFull;Landroid/content/Context;Landroid/view/View;)V
    .locals 0
...
.method public createInAppMessageView(Landroid/app/Activity;Lcom/braze/models/inappmessage/IInAppMessage;)Lcom/braze/ui/inappmessage/views/InAppMessageFullView;
    ...
    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getImageStyle()Lcom/braze/enums/inappmessage/ImageStyle;
    ...
    invoke-virtual {v9, p1, v1, v8}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->createAppropriateViews(Landroid/app/Activity;Lcom/braze/models/inappmessage/IInAppMessageImmersive;Z)V
    ...
    :cond_3
    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getBackgroundColor()I

    move-result p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageBackgroundColor(I)V

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getFrameColor()Ljava/lang/Integer;
    ...
    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setFrameColor(I)V

    :cond_4
    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getMessageButtons()Ljava/util/List;

    move-result-object p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageButtons(Ljava/util/List;)V

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getCloseButtonColor()I

    move-result p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageCloseButtonColor(I)V

    if-nez v8, :cond_7

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getMessage()Ljava/lang/String;

    move-result-object p2

    if-eqz p2, :cond_5

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessage(Ljava/lang/String;)V

    :cond_5
    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getMessageTextColor()I

    move-result p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageTextColor(I)V

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getHeader()Ljava/lang/String;

    move-result-object p2

    if-eqz p2, :cond_6

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageHeaderText(Ljava/lang/String;)V

    :cond_6
    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getHeaderTextColor()I

    move-result p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageHeaderTextColor(I)V

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getHeaderTextAlign()Lcom/braze/enums/inappmessage/TextAlign;

    move-result-object p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageHeaderTextAlignment(Lcom/braze/enums/inappmessage/TextAlign;)V

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getMessageTextAlign()Lcom/braze/enums/inappmessage/TextAlign;

    move-result-object p2

    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setMessageTextAlign(Lcom/braze/enums/inappmessage/TextAlign;)V

    invoke-virtual {v0}, Lcom/braze/models/inappmessage/InAppMessageFull;->getImageDownloadSuccessful()Z
    ...
    invoke-virtual {v9, p2}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setLargerCloseButtonClickArea(Landroid/view/View;)V

    move-object p2, v0

    check-cast p2, Lcom/braze/models/inappmessage/IInAppMessage;

    invoke-direct {p0, p1, p2, v9}, Lcom/braze/ui/inappmessage/factories/DefaultInAppMessageFullViewFactory;->resetLayoutParamsIfAppropriate(Landroid/app/Activity;Lcom/braze/models/inappmessage/IInAppMessage;Lcom/braze/ui/inappmessage/views/InAppMessageFullView;)Z
    ...
    invoke-virtual {v9, p1}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->setupDirectionalNavigation(I)V

    sget p1, Lcom/braze/ui/R$id;->com_braze_inappmessage_full_scrollview:I

    invoke-virtual {v9, p1}, Lcom/braze/ui/inappmessage/views/InAppMessageFullView;->findViewById(I)Landroid/view/View;
    ...
    new-instance v1, Lcom/braze/ui/inappmessage/factories/DefaultInAppMessageFullViewFactory$$ExternalSyntheticLambda0;
