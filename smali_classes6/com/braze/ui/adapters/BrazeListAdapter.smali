...
.method public batchSetCardsToRead(II)V
    ...
    invoke-virtual {p0}, Lcom/braze/ui/adapters/BrazeListAdapter;->getCount()I
    ...
    invoke-virtual {p0, p1}, Lcom/braze/ui/adapters/BrazeListAdapter;->getItem(I)Ljava/lang/Object;
...
.method public declared-synchronized replaceFeed(Ljava/util/List;)V
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/braze/ui/adapters/BrazeListAdapter;->setNotifyOnChange(Z)V

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lcom/braze/ui/adapters/BrazeListAdapter;->clear()V

    invoke-virtual {p0}, Lcom/braze/ui/adapters/BrazeListAdapter;->notifyDataSetChanged()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p0, v1}, Lcom/braze/ui/adapters/BrazeListAdapter;->getItem(I)Ljava/lang/Object;
    ...
    :cond_2
    invoke-virtual {p0, v3}, Lcom/braze/ui/adapters/BrazeListAdapter;->remove(Ljava/lang/Object;)V
