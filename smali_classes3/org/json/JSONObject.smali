...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lorg/json/JSONObject;->jsonParserConfiguration:Lorg/json/JSONParserConfiguration;
    ...
    iget-object p1, p0, Lorg/json/JSONObject;->jsonTokener:Lorg/json/JSONTokener;
...
.method public constructor <init>(Lorg/json/JSONTokener;Lorg/json/JSONParserConfiguration;)V
    ...
    iget-object v0, p0, Lorg/json/JSONObject;->jsonParserConfiguration:Lorg/json/JSONParserConfiguration;

    if-nez v0, :cond_0

    iput-object p2, p0, Lorg/json/JSONObject;->jsonParserConfiguration:Lorg/json/JSONParserConfiguration;

    :cond_0
    iget-object v0, p0, Lorg/json/JSONObject;->jsonTokener:Lorg/json/JSONTokener;

    if-nez v0, :cond_1

    iput-object p1, p0, Lorg/json/JSONObject;->jsonTokener:Lorg/json/JSONTokener;
    ...
    :cond_7
    const-string p2, "Strict mode error: Invalid character \';\' found"
    ...
    :cond_9
    const-string p2, "Strict mode error: Expected another object element"
    ...
    :cond_c
    const-string p2, "Expected a \':\' after a key"
    ...
    :cond_f
    const-string p2, "A JSONObject text must begin with \'{\'"
...
.method private populateMap(Ljava/lang/Object;Ljava/util/Set;)V
    ...
    invoke-static {v5}, Lorg/json/JSONObject;->isValidMethodName(Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_2

    invoke-static {v4}, Lorg/json/JSONObject;->getKeyNameFromMethod(Ljava/lang/reflect/Method;)Ljava/lang/String;
    ...
    invoke-static {v4, p2}, Lorg/json/JSONObject;->wrap(Ljava/lang/Object;Ljava/util/Set;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-static {v5}, Lorg/json/JSONObject;->recursivelyDefinedObjectException(Ljava/lang/String;)Lorg/json/JSONException;
...
.method static wrap(Ljava/lang/Object;ILorg/json/JSONParserConfiguration;)Ljava/lang/Object;
    .locals 1
...
.method public getEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
    ...
    invoke-static {p2, p1, v0, v1}, Lorg/json/JSONObject;->wrongValueFormatException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)Lorg/json/JSONException;
...
.method public similar(Ljava/lang/Object;)Z
    ...
    :cond_7
    instance-of v4, v2, Lorg/json/JSONString;

    if-eqz v4, :cond_8

    instance-of v4, v3, Lorg/json/JSONString;

    if-eqz v4, :cond_8

    check-cast v2, Lorg/json/JSONString;
